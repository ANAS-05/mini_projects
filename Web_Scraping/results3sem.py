...
headers = {
  ...
  'Cookie': 'JSESSIONID=56B45EC5DAB01FC0080E42D496D5EB22',
  'DNT': '1',
  'Origin': 'https://www.osmania.ac.in',
  'Referer': 'https://www.osmania.ac.in/res07/20240527.jsp',
...
for roll in range(160422733061,160422733121):
  ...
  cwd = os.getcwd()
  file_path = os.path.join(cwd,'web_scraper/results3sem.txt')
  try:
